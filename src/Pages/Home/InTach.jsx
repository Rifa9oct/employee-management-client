    ...
    return (
        <div className="max-w-[1320px] rounded-xl mx-auto my-20" style={bgImg}>
            ...
            <div className="flex justify-center flex-col lg:flex-row  gap-12 pt-10 pb-16">
                <div className="md:w-[500px] mx-auto lg:mx-0 h-[345px] bg-white rounded-lg">
                ...
                <div className="w-[300px] h-[345px] mx-auto lg:mx-0 flex flex-col items-start pl-10 rounded-lg justify-center bg-white">
